...
namespace Audiochan.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210913094907_Add_Added_Date_To_PlaylistAudios")]
    partial class Add_Added_Date_To_PlaylistAudios
    {
            ...
            modelBuilder.Entity("Audiochan.Domain.Entities.FavoritePlaylist", b =>
                {
                    ...
                    b.Property<long?>("PlaylistId1")
                        .HasColumnType("bigint")
                        .HasColumnName("playlist_id1");

                    b.HasKey("PlaylistId", "UserId")
                        .HasName("pk_favorite_playlists");

                    b.HasIndex("PlaylistId1")
                        .HasDatabaseName("ix_favorite_playlists_playlist_id1");
            ...
            modelBuilder.Entity("Audiochan.Domain.Entities.FavoritePlaylist", b =>
                {
                    ...
                    b.HasOne("Audiochan.Domain.Entities.Playlist", null)
                        ...
                        .HasConstraintName("fk_favorite_playlists_playlists_playlist_id1");

...
using Audiochan.Core.Commons.Dtos.Requests;
using Audiochan.Core.Commons.Dtos.Responses;
...
using Audiochan.Core.Features.Audios.Commands.RemovePicture;
...
using Audiochan.Core.Features.Audios.Queries.GetAudios;
using MediatR;

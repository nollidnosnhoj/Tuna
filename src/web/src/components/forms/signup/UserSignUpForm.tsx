...
export type UserSignUpInputs = z.infer<typeof userSignUpValidationSchema>;

interface UserSignUpFormProps {
  initialRef?: React.RefObject<HTMLInputElement>;
  onSubmit?: (values: UserSignUpInputs) => Promise<void>;
}

export default function UserSignUpForm(props: UserSignUpFormProps) {
  const formik = useForm<UserSignUpInputs>({
  ...
  const handleRegisterSubmit = async (values: UserSignUpInputs) => {
    try {
